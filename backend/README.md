...
## Project Structure
    ...
    ├── testapiautodatamod_113589  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_113589`
...
2. Clone this repo and `cd testapiautodatamod_113589`
